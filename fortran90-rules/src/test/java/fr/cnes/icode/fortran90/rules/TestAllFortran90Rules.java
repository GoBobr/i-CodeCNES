...
public class TestAllFortran90Rules implements ICodeCheckerTester {
    ...
    public static Object[][] data() {
        return new Object[][]{
                ...
                {"/EUM/NAME/IdLength/error.f90", "/EUM/NAME/IdLength/noError.f90", new int[]{2}, new String[]{"program essai"}, EUMNAMEIdLength.class},
                {"/EUM/NAME/IdChars/error.f90", "/EUM/NAME/IdChars/noError.f90", new int[]{2}, new String[]{"program essai"}, EUMNAMEIdChars.class},
                {"/EUM/INST/CharLen/error.f90", "/EUM/INST/CharLen/noError.f90", new int[]{2}, new String[]{"program essai"}, EUMINSTCharLen.class},
                {"/EUM/INST/DoubleColon/error.f90", "/EUM/INST/DoubleColon/noError.f90", new int[]{2}, new String[]{"program essai"}, EUMINSTDoubleColon.class},
                {"/EUM/INST/OneVarPerLine/error.f90", "/EUM/INST/OneVarPerLine/noError.f90", new int[]{2}, new String[]{"program essai"}, EUMINSTOneVarPerLine.class},
                {"/EUM/NAME/Constants/error.f90", "/EUM/NAME/Constants/noError.f90", new int[]{2}, new String[]{"program essai"}, EUMNAMEConstants.class},
                {"/EUM/NAME/ProgramName/error.f90", "/EUM/NAME/ProgramName/noError.f90", new int[]{1}, new String[]{"program"}, EUMNAMEProgramName.class},
                {"/EUM/NAME/ModuleName/error.f90", "/EUM/NAME/ModuleName/noError.f90", new int[]{1}, new String[]{"module"}, EUMNAMEModuleName.class},
                {"/EUM/INST/StringDim/error.f90", "/EUM/INST/StringDim/noError.f90", new int[]{2}, new String[]{"program essai"}, EUMINSTStringDim.class},
                {"/EUM/INST/FunctionIntent/error.f90", "/EUM/INST/FunctionIntent/noError.f90", new int[]{3}, new String[]{"function myfunc"}, EUMINSTFunctionIntent.class},
                {"/EUM/PRES/NoCommentMultiLine/error.f90", "/EUM/PRES/NoCommentMultiLine/noError.f90", new int[]{2}, new String[]{"program essai"}, EUMPRESNoCommentMultiLine.class},
                {"/EUM/PRES/IndentLevel/error.f90", "/EUM/PRES/IndentLevel/noError.f90", new int[]{2}, new String[]{"program essai"}, EUMPRESIndentLevel.class},
                {"/EUM/INST/OptionalAfterMandatory/error.f90", "/EUM/INST/OptionalAfterMandatory/noError.f90", new int[]{3, 4}, new String[]{"subroutine mysub", "subroutine mysub"}, EUMINSTOptionalAfterMandatory.class},
                {"/EUM/INST/ArgOrder/error.f90", "/EUM/INST/ArgOrder/noError.f90", new int[]{3, 4}, new String[]{"subroutine mysub", "subroutine mysub"}, EUMINSTArgOrder.class},
                {"/EUM/INST/DummyArgOrder/error.f90", "/EUM/INST/DummyArgOrder/noError.f90", new int[]{1}, new String[]{"subroutine mysub"}, EUMINSTDummyArgOrder.class},
                {"/EUM/NAME/PublicFormat/error.f90", "/EUM/NAME/PublicFormat/noError.f90", new int[]{3}, new String[]{"module XXyy_MyModule"}, EUMNAMEPublicFormat.class},
                {"/EUM/NAME/PrivateFormat/error.f90", "/EUM/NAME/PrivateFormat/noError.f90", new int[]{3}, new String[]{"module XXyy_MyModule"}, EUMNAMEPrivateFormat.class},
                {"/EUM/NAME/IdFormat/error.f90", "/EUM/NAME/IdFormat/noError.f90", new int[]{2}, new String[]{"program essai"}, EUMNAMEIdFormat.class},
                {"/EUM/PRES/CommentPos/error.f90", "/EUM/PRES/CommentPos/noError.f90", new int[]{2}, new String[]{"program essai"}, EUMPRESCommentPos.class},
                {"/EUM/DESIGN/ProgramStructure/error.f90", "/EUM/DESIGN/ProgramStructure/noError.f90", new int[]{1}, new String[]{"program essai"}, EUMDESIGNProgramStructure.class},
                {"/EUM/DESIGN/ModuleStructure/error.f90", "/EUM/DESIGN/ModuleStructure/noError.f90", new int[]{1}, new String[]{"Module"}, EUMDESIGNModuleStructure.class},
                {"/EUM/DESIGN/SubroutineStructure/error.f90", "/EUM/DESIGN/SubroutineStructure/noError.f90", new int[]{4}, new String[]{"program essai"}, EUMDESIGNSubroutineStructure.class},
                {"/EUM/INST/OptionalNamed/error.f90", "/EUM/INST/OptionalNamed/noError.f90", new int[]{2}, new String[]{"program essai"}, EUMINSTOptionalNamed.class},
                {"/EUM/INST/ArgTypeDecl/error.f90", "/EUM/INST/ArgTypeDecl/noError.f90", new int[]{1}, new String[]{"subroutine mysub"}, EUMINSTArgTypeDecl.class},
                {"/EUM/PRES/BlockAlign/error.f90", "/EUM/PRES/BlockAlign/noError.f90", new int[]{4}, new String[]{"program essai"}, EUMPRESBlockAlign.class},
                {"/EUM/DESIGN/NoGlobalVars/error.f90", "/EUM/DESIGN/NoGlobalVars/noError.f90", new int[]{5}, new String[]{"module XXyy_MyModule"}, EUMDESIGNNoGlobalVars.class},
                {"/EUM/INST/OptionalDefault/error.f90", "/EUM/INST/OptionalDefault/noError.f90", new int[]{1}, new String[]{"subroutine mysub"}, EUMINSTOptionalDefault.class},
                {"/EUM/INST/PureFunc/error.f90", "/EUM/INST/PureFunc/noError.f90", new int[]{1}, new String[]{"function myfunc"}, EUMINSTPureFunc.class},
                {"/EUM/TYPE/PrivateInType/error.f90", "/EUM/TYPE/PrivateInType/noError.f90", new int[]{4}, new String[]{"module XXyy_MyModule"}, EUMTYPEPrivateInType.class},
                {"/EUM/INST/NoUnderscoreKind/error.f90", "/EUM/INST/NoUnderscoreKind/noError.f90", new int[]{2}, new String[]{"program essai"}, EUMINSTNoUnderscoreKind.class},
                {"/EUM/INST/EqvOperators/error.f90", "/EUM/INST/EqvOperators/noError.f90", new int[]{5, 8}, new String[]{"program test_eqv", "program test_eqv"}, EUMINSTEqvOperators.class},
                {"/EUM/INST/NoSingleLineWhere/error.f90", "/EUM/INST/NoSingleLineWhere/noError.f90", new int[]{7}, new String[]{"program test_where"}, EUMINSTNoSingleLineWhere.class},
                {"/EUM/BLOC/WhereElse/error.f90", "/EUM/BLOC/WhereElse/noError.f90", new int[]{11}, new String[]{"program test_where_else"}, EUMBLOCWhereElse.class},
                {"/EUM/INST/NoLabelledDo/error.f90", "/EUM/INST/NoLabelledDo/noError.f90", new int[]{3}, new String[]{"program test_do"}, EUMINSTNoLabelledDo.class},
                {"/EUM/BLOC/NamedLoops/error.f90", "/EUM/BLOC/NamedLoops/noError.f90", new int[]{4}, new String[]{"program test_loops"}, EUMBLOCNamedLoops.class},
                {"/EUM/INST/FormatStmt/error.f90", "/EUM/INST/FormatStmt/noError.f90", new int[]{4}, new String[]{"program test_format"}, EUMINSTFormatStmt.class},
