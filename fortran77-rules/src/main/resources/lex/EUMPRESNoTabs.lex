...
%{
    private static final Logger LOGGER = Logger.getLogger(EUMPRESNoTabs.class.getName());
...
<COMMENT>   	{TAB}			{
                                    LOGGER.fine("Setting error line "+(yyline+1)+" due to tab character");
                                    setError(location,"Tab characters are not allowed.", yyline+1);
                                }
<COMMENT>   	.              	{}
