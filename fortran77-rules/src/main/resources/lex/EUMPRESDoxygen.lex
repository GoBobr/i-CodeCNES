...
%{
    private static final Logger LOGGER = Logger.getLogger(EUMPRESDoxygen.class.getName());
...
/************************/
<COMMENT>   	{DOXYGEN_BAD}	{
                                    LOGGER.fine("Setting error line "+(yyline+1)+" due to !< Doxygen marker");
                                    setError(location,"The !< Doxygen marker is not allowed, use !> instead.", yyline+1);
                                }
<COMMENT>   	\n             	{
