...
/********************************************************************************/
/* This file is used to generate a rule checker for EUM.PRES.NoEndLineComment.  */
/* End-of-line comments (! after code) are not allowed.                         */
/********************************************************************************/
...
%{
    private static final Logger LOGGER = Logger.getLogger(EUMPRESNoEndLineComment.class.getName());

	String location = "MAIN PROGRAM";
    String parsedFileName;

	public EUMPRESNoEndLineComment(){
	}
...
/* NEW_LINE STATE	    */
/************************/
<NEW_LINE>  	{LEADING_COMMENT}	{
                                    LOGGER.fine("["+this.parsedFileName+":"+(yyline+1)+":"+yycolumn+"] - NEW_LINE -> COMMENT (Transition : LEADING_COMMENT )");
                                    yybegin(COMMENT);
                                }
...
/************************/
/* LINE STATE    	    */
/* In LINE state, ! means end-of-line comment */
/************************/
<LINE>			{STRING}		{}
<LINE>			{TYPE}        	{
                                    location = yytext();
...
<LINE>			\!				{
                                    LOGGER.fine("Setting error line "+(yyline+1)+" due to end-of-line comment");
                                    setError(location,"End-of-line comments are not allowed.", yyline+1);
                                    yybegin(COMMENT);
                                }
<LINE>      	\n             	{
