...
/********************************************************************************/
/* This file is used to generate a rule checker for EUM.PRES.NoEmptyComment.    */
/* Empty comment lines (only ! or c/C with no text) are not allowed.            */
/********************************************************************************/
...
%{
    private static final Logger LOGGER = Logger.getLogger(EUMPRESNoEmptyComment.class.getName());

	String location = "MAIN PROGRAM";
    String parsedFileName;

	public EUMPRESNoEmptyComment(){
	}
...
/* NEW_LINE STATE	    */
/************************/
<NEW_LINE>  	{EMPTY_COMMENT}	{
                                    LOGGER.fine("Setting error line "+(yyline+1)+" due to empty comment line");
                                    setError(location,"Empty comment lines are not allowed.", yyline+1);
                                }
