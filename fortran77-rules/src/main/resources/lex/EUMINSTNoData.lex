...
/********************************************************************************/
/* This file is used to generate a rule checker for EUM.INST.NoData rule.       */
/* The DATA statement shall not be used for initialization.                     */
/********************************************************************************/
...
DATA		 = [^a-zA-Z0-9\_]("data")[^a-zA-Z0-9\_]
VAR		     = [a-zA-Z][a-zA-Z0-9\_]*
STRING		 = \'[^\']*\' | \"[^\"]*\"

%{
    private static final Logger LOGGER = Logger.getLogger(EUMINSTNoData.class.getName());

	String location = "MAIN PROGRAM";
    String parsedFileName;

	public EUMINSTNoData(){
	}
...
<NEW_LINE>		{DATA}			{
                                    LOGGER.fine("Setting error line "+(yyline+1)+" due to the keyword DATA");
                                    setError(location,"The DATA statement is not allowed for initialization.", yyline+1);
                                }
<NEW_LINE>  	\n             	{}
