...
/********************************************************************************/
/* This file is used to generate a rule checker for EUM.INST.Backspace rule.    */
/* The BACKSPACE keyword shall not be used.                                     */
/********************************************************************************/
...
BACKSPACE	 = [^a-zA-Z0-9\_]("backspace")[^a-zA-Z0-9\_]
VAR		     = [a-zA-Z][a-zA-Z0-9\_]*
STRING		 = \'[^\']*\' | \"[^\"]*\"

%{
    private static final Logger LOGGER = Logger.getLogger(EUMINSTBackspace.class.getName());

	String location = "MAIN PROGRAM";
    String parsedFileName;

	public EUMINSTBackspace(){
	}
...
<NEW_LINE>		{BACKSPACE}		{
                                    LOGGER.fine("Setting error line "+(yyline+1)+" due to the keyword BACKSPACE");
                                    setError(location,"The keyword BACKSPACE is not allowed.", yyline+1);
                                }
<NEW_LINE>  	\n             	{}
