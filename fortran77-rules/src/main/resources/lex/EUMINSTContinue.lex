...
/********************************************************************************/
/* This file is used to generate a rule checker for EUM.INST.Continue rule.     */
/* The standalone CONTINUE statement shall not be used (END CONTINUE is OK).    */
/********************************************************************************/
...
STRING		 = \'[^\']*\' | \"[^\"]*\"
END_CONTINUE	 = ("end"[\ ]+("continue"))
CONTINUE		 = [^a-zA-Z0-9\_]("continue")[^a-zA-Z0-9\_]

%{
    private static final Logger LOGGER = Logger.getLogger(EUMINSTContinue.class.getName());

	String location = "MAIN PROGRAM";
    String parsedFileName;

	public EUMINSTContinue(){
	}
...
<NEW_LINE>		{END_CONTINUE}	{}
<NEW_LINE>		{CONTINUE}		{
                                    LOGGER.fine("Setting error line "+(yyline+1)+" due to standalone CONTINUE");
                                    setError(location,"The standalone CONTINUE statement is not allowed.", yyline+1);
                                }
<NEW_LINE>  	\n             	{}
