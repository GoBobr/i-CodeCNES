...
/********************************************************************************/
/* This file is used to generate a rule checker for EUM.INST.BlockData rule.    */
/* The BLOCK DATA keyword shall not be used.                                    */
/********************************************************************************/
...
BLOCKDATA	 = [^a-zA-Z0-9\_]("block"[\ ]+("data"))[^a-zA-Z0-9\_]
VAR		     = [a-zA-Z][a-zA-Z0-9\_]*
STRING		 = \'[^\']*\' | \"[^\"]*\"

%{
    private static final Logger LOGGER = Logger.getLogger(EUMINSTBlockData.class.getName());

	String location = "MAIN PROGRAM";
    String parsedFileName;

	public EUMINSTBlockData(){
	}
...
<NEW_LINE>		{BLOCKDATA}		{
                                    LOGGER.fine("Setting error line "+(yyline+1)+" due to the keyword BLOCK DATA");
                                    setError(location,"The keyword BLOCK DATA is not allowed.", yyline+1);
                                }
<NEW_LINE>  	\n             	{}
