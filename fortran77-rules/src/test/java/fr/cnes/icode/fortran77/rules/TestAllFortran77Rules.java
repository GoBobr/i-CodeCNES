...
public class TestAllFortran77Rules implements ICodeCheckerTester {
    ...
    public static Object[][] data() {
        return new Object[][]{
                ...
                {"/EUM/NAME/IdLength/error.f", "/EUM/NAME/IdLength/noError.f", new int[]{2}, new String[]{"program essai"}, EUMNAMEIdLength.class},
                {"/EUM/NAME/IdChars/error.f", "/EUM/NAME/IdChars/noError.f", new int[]{2}, new String[]{"program essai"}, EUMNAMEIdChars.class},
                {"/EUM/INST/CharLen/error.f", "/EUM/INST/CharLen/noError.f", new int[]{2}, new String[]{"program essai"}, EUMINSTCharLen.class},
                {"/EUM/INST/DoubleColon/error.f", "/EUM/INST/DoubleColon/noError.f", new int[]{2}, new String[]{"program essai"}, EUMINSTDoubleColon.class},
                {"/EUM/INST/OneVarPerLine/error.f", "/EUM/INST/OneVarPerLine/noError.f", new int[]{2}, new String[]{"program essai"}, EUMINSTOneVarPerLine.class},
                {"/EUM/NAME/Constants/error.f", "/EUM/NAME/Constants/noError.f", new int[]{2}, new String[]{"program essai"}, EUMNAMEConstants.class},
                {"/EUM/NAME/ProgramName/error.f", "/EUM/NAME/ProgramName/noError.f", new int[]{1}, new String[]{"program"}, EUMNAMEProgramName.class},
                {"/EUM/NAME/ModuleName/error.f", "/EUM/NAME/ModuleName/noError.f", new int[]{1}, new String[]{"module"}, EUMNAMEModuleName.class},
                {"/EUM/INST/StringDim/error.f", "/EUM/INST/StringDim/noError.f", new int[]{2}, new String[]{"program essai"}, EUMINSTStringDim.class},
                {"/EUM/INST/FunctionIntent/error.f", "/EUM/INST/FunctionIntent/noError.f", new int[]{3}, new String[]{"function myfunc"}, EUMINSTFunctionIntent.class},
                {"/EUM/PRES/NoCommentMultiLine/error.f", "/EUM/PRES/NoCommentMultiLine/noError.f", new int[]{2}, new String[]{"program essai"}, EUMPRESNoCommentMultiLine.class},
                {"/EUM/PRES/IndentLevel/error.f", "/EUM/PRES/IndentLevel/noError.f", new int[]{2}, new String[]{"program essai"}, EUMPRESIndentLevel.class},
                {"/EUM/INST/OptionalAfterMandatory/error.f", "/EUM/INST/OptionalAfterMandatory/noError.f", new int[]{3, 4}, new String[]{"subroutine mysub", "subroutine mysub"}, EUMINSTOptionalAfterMandatory.class},
                {"/EUM/INST/ArgOrder/error.f", "/EUM/INST/ArgOrder/noError.f", new int[]{3, 4}, new String[]{"subroutine mysub", "subroutine mysub"}, EUMINSTArgOrder.class},
                {"/EUM/INST/DummyArgOrder/error.f", "/EUM/INST/DummyArgOrder/noError.f", new int[]{1}, new String[]{"subroutine mysub"}, EUMINSTDummyArgOrder.class},
                {"/EUM/NAME/PublicFormat/error.f", "/EUM/NAME/PublicFormat/noError.f", new int[]{3}, new String[]{"module XXyy_MyModule"}, EUMNAMEPublicFormat.class},
                {"/EUM/NAME/PrivateFormat/error.f", "/EUM/NAME/PrivateFormat/noError.f", new int[]{3}, new String[]{"module XXyy_MyModule"}, EUMNAMEPrivateFormat.class},
                {"/EUM/NAME/IdFormat/error.f", "/EUM/NAME/IdFormat/noError.f", new int[]{2}, new String[]{"program essai"}, EUMNAMEIdFormat.class},
                {"/EUM/PRES/CommentPos/error.f", "/EUM/PRES/CommentPos/noError.f", new int[]{2}, new String[]{"program essai"}, EUMPRESCommentPos.class},
                {"/EUM/DESIGN/ProgramStructure/error.f", "/EUM/DESIGN/ProgramStructure/noError.f", new int[]{1}, new String[]{"program essai"}, EUMDESIGNProgramStructure.class},
                {"/EUM/DESIGN/ModuleStructure/error.f", "/EUM/DESIGN/ModuleStructure/noError.f", new int[]{1}, new String[]{"Module"}, EUMDESIGNModuleStructure.class},
                {"/EUM/DESIGN/SubroutineStructure/error.f", "/EUM/DESIGN/SubroutineStructure/noError.f", new int[]{4}, new String[]{"program essai"}, EUMDESIGNSubroutineStructure.class},
                {"/EUM/INST/OptionalNamed/error.f", "/EUM/INST/OptionalNamed/noError.f", new int[]{2}, new String[]{"program essai"}, EUMINSTOptionalNamed.class},
                {"/EUM/INST/ArgTypeDecl/error.f", "/EUM/INST/ArgTypeDecl/noError.f", new int[]{1}, new String[]{"subroutine mysub"}, EUMINSTArgTypeDecl.class},
                {"/EUM/PRES/BlockAlign/error.f", "/EUM/PRES/BlockAlign/noError.f", new int[]{4}, new String[]{"program essai"}, EUMPRESBlockAlign.class},
                {"/EUM/DESIGN/NoGlobalVars/error.f", "/EUM/DESIGN/NoGlobalVars/noError.f", new int[]{5}, new String[]{"module XXyy_MyModule"}, EUMDESIGNNoGlobalVars.class},
                {"/EUM/INST/OptionalDefault/error.f", "/EUM/INST/OptionalDefault/noError.f", new int[]{1}, new String[]{"subroutine mysub"}, EUMINSTOptionalDefault.class},
                {"/EUM/INST/PureFunc/error.f", "/EUM/INST/PureFunc/noError.f", new int[]{1}, new String[]{"function myfunc"}, EUMINSTPureFunc.class},
                {"/EUM/TYPE/PrivateInType/error.f", "/EUM/TYPE/PrivateInType/noError.f", new int[]{4}, new String[]{"module XXyy_MyModule"}, EUMTYPEPrivateInType.class},
                {"/EUM/INST/NoUnderscoreKind/error.f", "/EUM/INST/NoUnderscoreKind/noError.f", new int[]{2}, new String[]{"program essai"}, EUMINSTNoUnderscoreKind.class},
                {"/EUM/INST/EqvOperators/error.f", "/EUM/INST/EqvOperators/noError.f", new int[]{5, 8}, new String[]{"program test_eqv", "program test_eqv"}, EUMINSTEqvOperators.class},
                {"/EUM/INST/NoSingleLineWhere/error.f", "/EUM/INST/NoSingleLineWhere/noError.f", new int[]{7}, new String[]{"program test_where"}, EUMINSTNoSingleLineWhere.class},
                {"/EUM/BLOC/WhereElse/error.f", "/EUM/BLOC/WhereElse/noError.f", new int[]{11}, new String[]{"program test_where_else"}, EUMBLOCWhereElse.class},
                {"/EUM/INST/NoLabelledDo/error.f", "/EUM/INST/NoLabelledDo/noError.f", new int[]{3}, new String[]{"program test_do"}, EUMINSTNoLabelledDo.class},
                {"/EUM/BLOC/NamedLoops/error.f", "/EUM/BLOC/NamedLoops/noError.f", new int[]{4}, new String[]{"program test_loops"}, EUMBLOCNamedLoops.class},
                {"/EUM/INST/FormatStmt/error.f", "/EUM/INST/FormatStmt/noError.f", new int[]{4}, new String[]{"program test_format"}, EUMINSTFormatStmt.class},
                {"/EUM/INST/FormatPlacement/error.f", "/EUM/INST/FormatPlacement/noError.f", new int[]{3}, new String[]{"subroutine mysub"}, EUMINSTFormatPlacement.class},
                {"/EUM/INST/FreeFormatRead/error.f", "/EUM/INST/FreeFormatRead/noError.f", new int[]{3}, new String[]{"program essai"}, EUMINSTFreeFormatRead.class},
                {"/EUM/NAME/FormatLabels/error.f", "/EUM/NAME/FormatLabels/noError.f", new int[]{4, 6}, new String[]{"program essai", "program essai"}, EUMNAMEFormatLabels.class},
                {"/EUM/INST/Redundant/error.f", "/EUM/INST/Redundant/noError.f", new int[]{3}, new String[]{"program essai"}, EUMINSTRedundant.class},
                {"/EUM/NAME/IdScope/error.f", "/EUM/NAME/IdScope/noError.f", new int[]{2}, new String[]{"program essai"}, EUMNAMEIdScope.class}
        };
    }
}
